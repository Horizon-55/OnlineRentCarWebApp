...
namespace OnlineRentCar.Migrations
{
    ...
    [Migration("20230627161042_AddAllCars")]
    partial class AddAllCars
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineRentCar.Models.Rent", b =>
                {
                    ...
                    b.HasOne("OnlineRentCar.Models.User", "Users")
                        .WithOne("Rent")
                        .HasForeignKey("OnlineRentCar.Models.Rent", "User")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineRentCar.Models.Returns", b =>
                {
                    ...
                    b.HasOne("OnlineRentCar.Models.User", "Users")
                        .WithOne("Returns")
                        .HasForeignKey("OnlineRentCar.Models.Returns", "User")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
